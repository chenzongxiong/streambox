...
#include "math.h"
#include "util/jcm_toolbox.h"

template <class Eval>
double zeroin(double ax,double bx, Eval* f,double tol)   /* An estimate to the root	*/
...
//double tol;				/* Acceptable tolerance		*/
{
  ...
  for(;;counter++)		/* Main iteration loop	*/
  {
    ...
    const double EPSILON = JCMUtil::DoublePrec;
