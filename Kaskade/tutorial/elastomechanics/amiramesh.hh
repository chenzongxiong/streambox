  ...
  void WriteRestrictedAmira(const char *fileName)
    {
	  ...
	  McPrimType::McPrimType floatType(&usedFloatCoords[0][0]);
	  AmiraMesh::Location outVert("Nodes", nUsedPoints);
	  AmiraMesh::Data::Data outCoord("Coordinates", &outVert, floatType, 3, &usedFloatCoords[0][0]);
	  ...
	  McPrimType::McPrimType intType(&usedTetI[0][0]);
	  AmiraMesh::Location outTet("Tetrahedra", nUsedTet);
	  AmiraMesh::Data::Data outNodes("Nodes", &outTet, intType, 4, &usedTetI[0][0]);
	  outMesh->insert(&outTet);
	  outMesh->insert(&outNodes);

	  McPrimType::McPrimType byteType(&usedMatIds[0]);
	  AmiraMesh::Location outTetData("TetrahedronData", nUsedTet);
	  AmiraMesh::Data::Data outBndIds("BndIds", &outTetData, byteType, 5, &usedBndCharId[0]);
	  outMesh->insert(&outBndIds);

	  AmiraMesh::Location outBtr("BoundaryTriangles", nUsedBndTr);
	  AmiraMesh::Data::Data outBtrNodes("Nodes", &outBtr, intType, 3, &usedBndTrI[0][0]);
	  outMesh->insert(&outBtr);
	  outMesh->insert(&outBtrNodes);

	  AmiraMesh::Location outBtrData("BoundaryTriangleData", nUsedBndTr);
	  AmiraMesh::Data::Data outBtrId("Id", &outBtrData, byteType, 1, &usedBndIds[0]);
  ...
  void WriteAmiraSolution(Grid *grid, const char *fileName, int size, int nSol, int solSize, double *x)
    {
	  ...
	  McPrimType::McPrimType floatType(&floatCoords[0][0]);
	  AmiraMesh::Location outVert("Nodes", nPoints);
	  AmiraMesh::Data::Data outCoord("Coordinates", &outVert, floatType, 3);
	  ...
	  McPrimType::McPrimType intType(&tetI[0][0]);
	  AmiraMesh::Location outTet("Tetrahedra", nTet);
	  AmiraMesh::Data::Data outNodes("Nodes", &outTet, intType, 4);
	  outMesh->insert(&outTet);
	  outMesh->insert(&outNodes);
	  ...
	  McPrimType::McPrimType byteType(&bndIds[0]);
	  AmiraMesh::Location outMatLoc("Tetrahedra", nTet);
	  AmiraMesh::Data::Data outMatData("Materials", &outMatLoc, byteType, 1);
...
// 	  AmiraMesh::Data::Data outBtrNodes("Nodes", &outBtr, intType, 3, &bndTrI[0][0]);
// 	  outMesh->insert(&outBtr);
// 	  outMesh->insert(&outBtrNodes);
// 
// 	  AmiraMesh::Location outBtrLoc("BoundaryTriangles", nBndTr);
// 	  AmiraMesh::Data::Data outBtrId("Id", &outBtrLoc, byteType, 1, &bndIds[0]);
// 	  outMesh->insert(&outBtrId);

	  AmiraMesh::Location outU("Nodes", nPoints);
	  AmiraMesh::Data::Data outUData("UValues", &outU, floatType, 3);
	  ...
	  AmiraMesh::Data::Data outVData("VValues", &outV, floatType, 3);
