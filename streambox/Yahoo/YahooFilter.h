#ifndef YAHOOFILTER_H
#define YAHOOFILTER_H
#include <re2/re2.h>
#include "Mapper/Mapper.h"
#include "Yahoo/YahooRecord.h"
#include "Values.h"
// #include "core/Transforms.h"
template <typename InputT = YahooRecord, typename OutputT = YahooRecord, template<class> class BundleT_ = RecordBundle>
class YahooFilter : public Mapper<InputT> {
    using OutputBundleT = BundleT_<OutputT>;
public:
YahooFilter(string name = "yahoo_filter") : Mapper<InputT>(name), record_counter_(0) { }
