...
template <class Eval>
double zeroin(double ax,double bx, Eval const&  f, double tol, int& counter, int maxit)   /* An estimate to the root	*/
...
//double tol;				/* Acceptable tolerance		*/
{
  ...
  for(;counter < maxit+2;counter++)		/* Main iteration loop	*/
  {
