...
#ifndef CREEK_WINKEYREDUCEREVAL_YAHOO_COMMON_H
#define CREEK_WINKEYREDUCEREVAL_YAHOO_COMMON_H
...
//				abort();
        ...
        for (auto && r : gres) {
            ...
            // cout << "win.start: " << win.epoch + win.start << endl;
            // cout << "win.end: " << win.epoch + win.start + win.duration << endl;
            /* @vecptr is a shared ptr pointing to a vector that contains KV pairs.
             * it is a window's worth of reduce result produced by one worker.
             */
            for (auto & vecptr : vec_of_vecptr) {
...
#endif //CREEK_WINKEYREDUCEREVAL_YAHOO_COMMON_H
