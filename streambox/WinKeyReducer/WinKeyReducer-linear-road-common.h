#ifndef CREEK_WINKEYREDUCER_LINEAR_ROAD_COMMON_H
#define CREEK_WINKEYREDUCER_LINEAR_ROAD_COMMON_H
...
template<>
std::pair<uint64_t, long> MyWinKeyReducer::do_reduce
...
template<>
std::pair<uint64_t, long> MyWinKeyReducer::do_reduce_unsafe
...
#endif //CREEK_WINKEYREDUCER_LINEAR_ROAD_COMMON_H
