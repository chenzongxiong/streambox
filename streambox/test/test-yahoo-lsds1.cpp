...
// 		.record_size = 1000,
// 		.input_file =
// "/root/dfki/Streaming-Hackathon-2017/StreamBench/streambox/data_test/Data.txt"
//         ,
...
void testYahooBenchmark()
{
  ...
  // config.cores = 2;
    ...
    std::ifstream infile(
"/home/zxchen/data_test/CampAds.txt"
        );
    std::string line;
    ...
    UnboundedInMem<Event1, BundleT> yahooSource(
            "[yahooSource]",
    ...
    // With group by
    YahooMapper<Event1, pair<creek::string,long>, BundleT> mapper ("[yahoo-mapper]", campaigns);
