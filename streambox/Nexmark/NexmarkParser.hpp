#ifndef NEXMARK_PARSER_HPP
#define NEXMARK_PARSER_HPP
...
template <typename InputT=string_range,
          ...
          >
class NexmarkParser : public Mapper<InputT> {
    using OutputBundleT = BundleT_<OutputT>;

public:
    NexmarkParser(string name="nexmark_parser") : Mapper<InputT>(name), record_counter_(0), byte_counter_(0) {}
