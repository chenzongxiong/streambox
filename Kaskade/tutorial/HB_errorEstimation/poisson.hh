...
/// \example heat.cpp
/// show the usage of PoissonFunctional describing a stationary heat transfer problem with peak formed source, 
/// and adapted grids by PrecondType::HB error estimator
///
#endif
