...
public:
  ...
  public:
    ...
    Scalar d1_impl (VariationalArg<Scalar,dim,TestComponents<row>::value> const& arg) const
    {
      if(row == uIdx)
      {
        Dune::FieldMatrix<Scalar,dim,dim> dv;
        dv << arg.derivative;
    ...
    Scalar d2_impl (VariationalArg<Scalar,dim,TestComponents<row>::value> const &arg1, VariationalArg<Scalar,dim,AnsatzComponents<col>::value> const &arg2) const
    {
      ...
      {
        Dune::FieldMatrix<Scalar,dim,dim> dv, dw;
        dv << arg1.derivative;
        dw << arg2.derivative;
  ...
  public:
    ...
    Scalar d1_impl (VariationalArg<Scalar,dim,TestComponents<row>::value> const& arg) const
    {
      if(row == uIdx)
      {
        Dune::FieldVector<Scalar,dim> dv = if_(arg.value,u);
    ...
    Scalar d2_impl (VariationalArg<Scalar,dim,TestComponents<row>::value> const &arg1, VariationalArg<Scalar,dim,AnsatzComponents<col>::value> const &arg2) const
    {
      if(row == uIdx && col == uIdx)
      {
        Dune::FieldVector<Scalar,dim> dv, dw; dv << arg1.value; dw << arg2.value;
  ...
  private:
    ...
    Scalar gamma;
    Dune::FieldVector<Scalar,dim> u, u0;
  };
